...
const Partner = () => {
    ...
    return (
        ...
        <div className="d-flex justify-content-between position-relative p-2">
            <div style={{ color:"orange" }}><i class="fa-solid fa-chevron-down"></i></div>
            <div style={{ color:"orange" }}> الاعتمادات التي توفرها النورس</div>
        </div>
        </Button>
        <Collapse in={open}>
        ...
        >
        <div className="d-flex justify-content-between position-relative p-2">
            <div style={{ color:"var(--main-color)" }}><i class="fa-solid fa-chevron-down"></i></div>
            <div style={{ color:"var(--main-color)" }}> هل يعتد بهذة الشهادة من قبل الجهات الحكومية ؟</div>
        </div>
        </Button>
        <Collapse in={open1}>
            <div id="example-collapse-text">
    ...
    <div className="d-flex justify-content-between position-relative p-2">
        <div style={{ color:"orange" }}><i class="fa-solid fa-chevron-down"></i></div>
        <div style={{ color:"orange" }}>خطط النورس للاعتمادات المستقبلية</div>
    </div>
    </Button>
    <Collapse in={open4}>
        <div id="example-collapse-text">
